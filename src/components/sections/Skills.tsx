        ...
        >
          ...
          <Card className="group hover:scale-[1.01] transition-all duration-500 bg-gradient-to-br from-white/10 to-white/5 dark:bg-slate-900/20 backdrop-blur-xl border border-white/10 shadow-2xl">
            <CardContent className="p-8">
              <h3 className="text-2xl font-semibold text-blue-400 mb-8">Development</h3>
          ...
          <Card className="group hover:scale-[1.01] transition-all duration-500 bg-gradient-to-br from-white/10 to-white/5 dark:bg-slate-900/20 backdrop-blur-xl border border-white/10 shadow-2xl">
            <CardContent className="p-8">
              <h3 className="text-2xl font-semibold text-blue-400 mb-8">Programming</h3>
              <div className="grid grid-cols-2 sm:grid-cols-3 gap-6">
          ...
          <Card className="group hover:scale-[1.01] transition-all duration-500 bg-gradient-to-br from-white/10 to-white/5 dark:bg-slate-900/20 backdrop-blur-xl border border-white/10 shadow-2xl">
            <CardContent className="p-8">
              <h3 className="text-2xl font-semibold text-blue-400 mb-8">Tools & Platforms</h3>
